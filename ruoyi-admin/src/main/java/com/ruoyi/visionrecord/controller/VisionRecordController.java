 ...
 */
@RestController
@RequestMapping("/visionrecord/visonrecord")
public class VisionRecordController extends BaseController
{
     ...
     * 查询视力监测记录列表
     */
    @PreAuthorize("@ss.hasPermi('visionrecord:visonrecord:list')")
    @GetMapping("/list")
     ...
     * 导出视力监测记录列表
     */
    @PreAuthorize("@ss.hasPermi('visionrecord:visonrecord:export')")
     ...
     * 获取视力监测记录详细信息
     */
    @PreAuthorize("@ss.hasPermi('visionrecord:visonrecord:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增视力监测记录
     */
    @PreAuthorize("@ss.hasPermi('visionrecord:visonrecord:add')")
     ...
     * 修改视力监测记录
     */
    @PreAuthorize("@ss.hasPermi('visionrecord:visonrecord:edit')")
     ...
     * 删除视力监测记录
     */
    @PreAuthorize("@ss.hasPermi('visionrecord:visonrecord:remove')")
